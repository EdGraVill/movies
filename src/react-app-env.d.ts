...
declare namespace MovieDB {
  ...
  namespace Arguments {
    ...
    namespace Movie {
      ...
      type GetCredits = Common;

      type GetExternalIDs = Common;
      ...
      type GetKeywords = Common;

      type GetReleaseDates = Common;

      type GetVideos = Common;

      type GetTranslations = Common;
      ...
      type GetPopular = GetNowPlaying;

      type GetTopRated = GetNowPlaying;

      type GetUpcoming = GetNowPlaying;
    ...
    namespace Network {
      ...
      type GetAlternativeNames = Common;

      type GetImages = Common;
    }
    ...
    namespace Person {
      ...
      type GetMovieCredits = Common;

      type GetTVCredits = Common;

      type GetCombinedCredits = Common;
    ...
    namespace TV {
      ...
      type GetContentRatings = Common;

      type GetCredits = Common;

      type GetEpisodeGroups = Common;
      ...
      type GetScreenedTheatrically = Common;
      ...
      type GetOnAir = GetAiringToday;

      type GetPopular = GetAiringToday;

      type GetTopRated = GetAiringToday;
  ...
  namespace Responses {
    ...
    namespace Account {
      ...
      type MarkAsFavorite = Objects.Status;
      ...
      type AddToWatchlist = Objects.Status;
    }
    ...
    namespace Find {
      type ByExternalID = ByExternalIDMovie | ByExternalIDTV | ByExternalIDTVEpisode | ByExternalIDPerson;
    ...
    namespace List {
      ...
      type AddMovie = Objects.Status;

      type RemoveMovie = Objects.Status;

      type ClearList = Objects.Status;

      type DeleteList = Objects.Status;
    }
    ...
    namespace Movie {
      ...
      type GetAccountStates = Objects.AccountStates;

      type GetAlternativeTitles = Objects.AlternativeTitles;

      type GetChanges = Objects.ChangesMovie;
      ...
      type GetExternalIDs = Objects.MovieExternalIDs;
      ...
      type GetReviews = Objects.Reviews;
      ...
      type RateMovie = Objects.Status;

      type DeleteRating = Objects.Status;
    ...
    namespace Search {
      ...
      interface Multi extends ResponseWithPage {
        results: (Objects.MovieWithMediaType | Objects.TVShowWithMediaType | Objects.PersonWithMediaType)[];
      }
    ...
    namespace TV {
      ...
      type GetExternalIDs = Objects.TVShowExternalIDs;
      ...
      type RateTVShow = Objects.Status;
      ...
      namespace Episode {
        ...
        type RateTVEpisode = Objects.Status;
